...
/* ── Strategy-account mock fallback (mirrors backend /api/strategy-accounts) ── */
export const MOCK_SOURCES = [
  ...
  },
  {
    ...
    notes: "Best for observed on-chain wallets, including Mantle smart trader labels.",
  },
  {
...
export const MOCK_STRATEGY_ACCOUNTS = [
  {
    ...
    period: "30d",
    metrics: { roiPct: 18.4, winRatePct: 64.2, maxDrawdownPct: 7.8, tradeCount: 126, volumeUsd: 820000, consistencyPct: 71 },
    txHashes: [],
    sourceProofUrl: "https://www.bybit.com/copyTrading",
    notes: "Demo import of an existing copy-trading strategy account.",
    proofStatus: "offchain_verified_pending_anchor",
    dataHash: "0xab2c71d1fc3ee9604ebf15e0bfe7b443cbbf197a84299d3abf8807473d500d9f",
    credoraScore: 71.79,
  },
  {
    id: "nansen-smart-money:mantle-smart-wallet-demo",
    source: "nansen-smart-money",
    sourceType: "onchain_analytics",
    sourcePlatform: "Nansen / Mantle",
    externalAccountId: "mantle-smart-wallet-demo",
    displayName: "Mantle Smart Wallet",
    accountType: "imported_public_account",
    verificationLevel: "public_track_record",
    walletAddress: "0x9f3a000000000000000000000000000000000be21",
    chain: "mantle-sepolia",
    markets: ["MNT/USDT", "mETH/USDT"],
    period: "30d",
    metrics: { roiPct: 11.2, winRatePct: 58.0, maxDrawdownPct: 9.1, tradeCount: 88, volumeUsd: 410000, consistencyPct: 66 },
    txHashes: [],
    sourceProofUrl: "https://app.nansen.ai/",
    notes: "Observed on-chain smart-money wallet.",
    proofStatus: "offchain_verified_pending_anchor",
    dataHash: "0x1be4000000000000000000000000000000000077ac",
    credoraScore: 68.5,
  },
];
